...
const SUNSET_SEQUENCE_WEBM = "/harbour-animation/harbour-sunset-transition.webm?v=geometry-lock-1"
const SUNSET_SEQUENCE_MP4 = "/harbour-animation/harbour-sunset-transition.mp4?v=geometry-lock-1"
const EVENING_LOOP_WEBM = "/harbour-animation/harbour-evening-loop.webm?v=geometry-lock-1"
const EVENING_LOOP_MP4 = "/harbour-animation/harbour-evening-loop.mp4?v=geometry-lock-1"
